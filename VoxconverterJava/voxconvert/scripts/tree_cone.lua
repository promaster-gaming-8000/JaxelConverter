...
function arguments()
	return {
		{ name = 'trunkHeight', desc = 'Height of the trunk', type = 'int', default = '5' },
		{ name = 'trunkStrength', desc = 'Thickness of the trunk', type = 'int', default = '1' },
		{ name = 'leavesWidth', desc = 'Width of the leaves', type = 'int', default = '10' },
		{ name = 'leavesHeight', desc = 'Height of the leaves', type = 'int', default = '20' },
...
function main(node, region, color, trunkHeight, trunkStrength, leavesWidth, leavesHeight, leavesDepth, trunkColor, leavesColor, seed)
	...
	g_shape.cone(volume, leavesCenter, 'y', false, leavesWidth, leavesHeight, leavesDepth, leavesVoxel)
end
